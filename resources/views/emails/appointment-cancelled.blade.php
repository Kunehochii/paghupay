...
<body>
    ...
    <div class="content">
        ...
        <div class="reason-box">
            <h3>⚠️ Reason for Cancellation</h3>
            <p>{{ $reason }}</p>
        </div>

        <div class="action-text">
            <h3>📅 What's Next?</h3>
            <p>You can book a new appointment through the Paghupay system at your convenience. We apologize for any inconvenience this may have caused.</p>
        </div>
        
        <p>If you have any questions or concerns, please don't hesitate to contact the Guidance Office.</p>
