...
@section('content')
    <div class="schedule-page">
        ...
        <div class="container py-4">
            ...
            <!-- Schedule Card -->
            <form action="/booking/schedule/{{ $counselor->id }}" method="POST" id="scheduleForm">
                @csrf
...
@push('scripts')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const counselorUnavailableDates = @json($counselorUnavailableDates ?? []);
            ...
            function renderCalendar() {
                ...
                for (let day = 1; day <= daysInMonth; day++) {
                    ...
                    const isCounselorUnavailable = counselorUnavailableDates.includes(dateString);
                    ...
                    } else if (isPast || isFuture || isBlocked || isCounselorUnavailable) {
                        dayBtn.classList.add('disabled');
                        dayBtn.disabled = true;
                        if (isCounselorUnavailable) {
                            dayBtn.title = 'Counselor is not available on this date';
                        }
                    } else {
            ...
            function selectDate(dateString, day) {
                ...
                console.log('Current calendar month:', currentDate.getMonth(), '(' + monthNames[currentDate
                    .getMonth()] + ')');
            ...
            function renderTimeSlots(data) {
                ...
                if (hasAvailableSlots || (data.morning && data.morning.length > 0) || (data.afternoon && data
                        .afternoon.length > 0)) {
