        ...
        <div class="col-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Edit Case Log</li>
                </ol>
            </nav>
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2 class="text-success mb-0">
                        <i class="bi bi-journal-text"></i> Case Log Entry
                    </h2>
                    <small class="text-muted">{{ $caseLog->case_log_id }}</small>
                </div>
                @if($caseLog->appointment->status !== 'completed')
                ...
                <div class="card-body py-3">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-3">
                            ...
                            <strong>{{ $caseLog->appointment->scheduled_at->format('M j, Y') }}</strong>
                        </div>
                        <div class="col-md-3">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header bg-primary text-white">
                        <h5 class="mb-0"><i class="bi bi-pencil-square"></i> Session Notes</h5>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <small class="text-muted">This information is encrypted and kept confidential.</small>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="additional_notes" class="form-label">
                                        <i class="bi bi-card-text"></i> Additional Notes / Recommendations
                                    </label>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header bg-success text-white d-flex justify-content-between align-items-center">
                        ...
                        <button type="button" class="btn btn-sm btn-light" id="addGoalBtn">
                    ...
                    <div class="card-body d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <span class="text-muted">
                                ...
                                Appointment is already completed. You can still edit the case log.
                            </span>
                            @endif
                        </div>
                        <div>
                            <a href="{{ route('counselor.case-logs.index') }}" class="btn btn-secondary me-2">
