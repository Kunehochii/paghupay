                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control-custom @error('nickname') is-invalid @enderror"
                                name="nickname" value="{{ old('nickname') }}" placeholder="" required>
                            @error('nickname')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text"
                                ...
                                name="course_year_section" value="{{ old('course_year_section') }}" placeholder="" required>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <div class="checkbox-group">
                                <div class="checkbox-item">
                                    <input type="checkbox" id="sex_male" name="sex" value="Male"
                                        {{ old('sex') == 'Male' ? 'checked' : '' }} onchange="handleSexSelection('Male')">
                                    <label for="sex_male">Male</label>
                                </div>
                                <div class="checkbox-item">
                                    <input type="checkbox" id="sex_female" name="sex" value="Female"
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control-custom @error('birthdate') is-invalid @enderror"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control-custom @error('birthplace') is-invalid @enderror"
                                name="birthplace" value="{{ old('birthplace') }}" placeholder="" required>
                            @error('birthplace')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control-custom @error('contact_number') is-invalid @enderror"
                                name="contact_number" value="{{ old('contact_number') }}" placeholder="" required>
                        ...
                        <div class="form-group">
                            ...
                            <small class="text-muted" style="font-size: 0.75rem;">You may change this to your preferred
                                notification email.</small>
                            @error('email')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control-custom @error('fb_account') is-invalid @enderror"
                                name="fb_account" value="{{ old('fb_account') }}" placeholder="">
                            @error('fb_account')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control-custom @error('nationality') is-invalid @enderror"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control-custom @error('address') is-invalid @enderror"
                                name="address" value="{{ old('address') }}" placeholder="" required>
                            @error('address')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control-custom @error('home_address') is-invalid @enderror"
                                name="home_address" value="{{ old('home_address') }}" placeholder="" required>
                            @error('home_address')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text"
                                ...
                                name="guardian_name" value="{{ old('guardian_name') }}" placeholder="" required>
                            @error('guardian_name')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text"
                                ...
                                name="guardian_relationship" value="{{ old('guardian_relationship') }}" placeholder=""
                                required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text"
                                ...
                                name="guardian_contact" value="{{ old('guardian_contact') }}" placeholder="" required>
