...
<head>
    ...
    <title>{{ config('app.name', 'Paghupay') }} - Counselor Login</title>
...
<body>
    ...
    <nav class="login-navbar d-flex justify-content-between align-items-center">
        ...
        <div class="d-flex align-items-center">
            ...
            <a href="{{ route('counselor.login') }}" class="btn btn-login-nav">Log in</a>
        </div>
    </nav>
        ...
        <div class="login-container">
            ...
            <div class="form-side">
                <div class="login-card">
                    ...
                    <!-- Title -->
                    <h2 class="login-title">Counselor Login</h2>
                    ...
                    <div class="security-notice">
                        ...
                        <strong>Security Notice:</strong> Your account will be bound to this device on first login. Contact admin if you need to switch devices.
                    </div>
